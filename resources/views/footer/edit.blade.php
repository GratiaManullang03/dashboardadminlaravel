...
@section('title', 'Edit Item Footer - Pazar Admin')

@section('page-title', 'Edit Item Footer')
...
@section('content')
    ...
    <x-card>
        <form action="{{ route('footer.update', $footer->f_id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                    <x-form.input 
                        ...
                        :value="old('f_icon', $footer->f_icon)"
