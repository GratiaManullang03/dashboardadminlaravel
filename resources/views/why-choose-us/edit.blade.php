...
@section('title', 'Edit Why Choose Us - Pazar Admin')

@section('page-title', 'Edit Why Choose Us')
...
@section('content')
    ...
    <x-card>
        <form action="{{ route('why-choose-us.update', $whyChooseUs->w_id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                    <x-form.input 
                        ...
                        :value="old('w_title_id', $whyChooseUs->w_title_id)"
                        required
                    />
                </div>
                ...
                <div>
                    <x-form.input 
                        ...
                        :value="old('w_title_en', $whyChooseUs->w_title_en)"
                        required
                    />
                </div>
                ...
                <div>
                    <x-form.textarea 
                        ...
                        :value="old('w_description_id', $whyChooseUs->w_description_id)"
                        rows="4"
                    />
                </div>
                ...
                <div>
                    <x-form.textarea 
                        ...
                        :value="old('w_description_en', $whyChooseUs->w_description_en)"
                        rows="4"
                    />
                </div>
                ...
                <div class="md:col-span-2">
                    <x-form.input 
                        ...
                        :value="old('w_icon', $whyChooseUs->w_icon)"
