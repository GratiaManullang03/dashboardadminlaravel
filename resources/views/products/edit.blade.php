...
@section('title', 'Edit Produk - Pazar Admin')
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                    <x-form.input 
                        ...
                        :value="old('p_link', $product->p_link)"
                ...
                <div>
                    ...
                    @if($product->p_image)
                        <div class="mb-3">
                            <img src="{{ asset('storage/' . $product->p_image) }}" alt="Current Product Image" class="w-32 h-32 object-cover rounded">
                ...
                <div>
                    <x-form.checkbox 
                        ...
                        id="p_is_active" 
                        label="Produk Aktif" 
                        :checked="old('p_is_active', $product->p_is_active)"
