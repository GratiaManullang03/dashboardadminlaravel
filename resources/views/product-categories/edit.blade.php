...
@section('title', 'Edit Kategori Produk - Pazar Admin')
...
@section('content')
    ...
    <x-card>
        <form action="{{ route('product-categories.update', $productCategory->pc_id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                    <x-form.input 
                        ...
                        :value="old('pc_title_id', $productCategory->pc_title_id)"
                        required
                    />
                </div>
                ...
                <div>
                    <x-form.input 
                        ...
                        :value="old('pc_title_en', $productCategory->pc_title_en)"
                        required
                    />
                </div>
                ...
                <div>
                    <x-form.textarea 
                        ...
                        :value="old('pc_description_id', $productCategory->pc_description_id)"
                        rows="4"
                    />
                </div>
                ...
                <div>
                    <x-form.textarea 
                        ...
                        :value="old('pc_description_en', $productCategory->pc_description_en)"
                        rows="4"
                    />
                </div>
                ...
                <div>
                    <x-form.input 
                        ...
                        :value="old('pc_link', $productCategory->pc_link)"
                ...
                <div>
                    ...
                    @if($productCategory->pc_image)
                        <div class="mb-3">
                            <img src="{{ asset('storage/' . $productCategory->pc_image) }}" alt="Current Category Image" class="w-32 h-32 object-cover rounded">
